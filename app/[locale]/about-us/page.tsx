...
const content = {
  ...
  mn: {
    ...
    pillars: [
      {
        num: "01",
        title: "Хоймор нутгийн өв",
        body: "Бид энэ нутагтаа гурван үеэрээ ажиллаж амьдарч буй гэр бүл, нутгийн иргэдээс бүрдсэн хамт олон. Зочиддоо чин сэтгэлээсээ үйлчилж, онгон зэрлэг байгальтай танилцах жинхэнэ аяллыг санал болгодог.",
      },
      {
        num: "02",
        title: "Байгальд ууссан шийдэл",
        body: "Бид байгалийн унаган төрхийг алдагдуулахгүйгээр, цэвэр модон хийц, байгалийн элементүүдийг ашиглан амьд байгаль дахь тав тухыг цогцлоодог.",
      },
      {
        num: "03",
        title: "Байгалийн шим",
      ...
      },
      {
        ...
        body: "Хойд хязгаар руу аялах нь бэрхшээлтэй мэт санагдаж болох ч бид бүх зүйлийг хөнгөвчилнө. Захиалга өгөхөөс эхлээд биднийг зорин ирэх хүртэлх бүх аяллыг тань ямар ч саадгүй, тав тухтай байхаар зохион байгуулдаг.",
      },
      {
        num: "05",
    ...
    founderBody: [
      "Хөвсгөл бол бидний өлгий нутаг. Үүсгэн байгуулагч маань энэхүү дууг нутгийн зон олныг ундаалан тэтгэдэг Хөвсгөл нууртаа зориулан бүтээсэн түүхтэй. Өнөөдөр бид гэр бүлээрээ энэхүү амар амгалан, байгалийн сайхныг зочидтойгоо хуваалцан ажиллаж байна. Манайд тавтай морилно уу.",
