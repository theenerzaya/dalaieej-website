    ...
    pillars: [
      {
        ...
        body: "Anchored in the North. We are a three-generation family and a local team, delivering intuitive, honest hospitality as your unvarnished gateway into the wilderness.",
      },
      {
        num: "02",
        title: "Built for the Wilderness",
        body: "We forge with living timber and open fire. We tread lightly, offering spaces built from real elements where the primeval landscape takes center stage.",
      },
      {
        num: "03",
        title: "Untamed Elements",
        body: "No imported illusions. We serve source water, wild-caught fish, and mountain-grazed meat. It is through these raw elements that the soul is replenished.",
      },
      {
        num: "04",
        title: "Clear Passage",
        body: "The Taiga is vast. We strip away the friction of remote travel. From your first booking to the moment you step onto our soil, we ensure your passage North is completely seamless.",
      },
      {
        num: "05",
      ...
      },
      {
        num: "06",
        title: "The Open Sky",
        body: "The wild strips away pretense. Under the Taiga sky, global travelers and locals converge with an open heart. An unvarnished social scene built on absolute, genuine connection.",
      },
    ],
    ...
    pillars: [
      {
        ...
        body: "Бид бол энэ нутгийн гурван үеийн түүхтэй гэр бүл. Манай хамт олон хүнийг хүндэлсэн, үнэн сэтгэлийн үйлчилгээгээр догшин тайгын үнэн дүр төрх рүү нэвтрэх үүд хаалгыг нээж өгнө.",
      },
      {
        num: "02",
        title: "Байгальд ууссан хийц",
        body: "Амьд мод, дүрэлзэх гал. Бид байгальд ул мөр үлдээхгүйгээр, бүхэл гуалин, бодит элементүүдээр тайгын тав тухыг урладаг.",
      },
      {
        num: "03",
        title: "Тайгын шим",
        body: "Хуурмаг орц үгүй. Уулын гүний ус, унаган хөрсний мах, зэрлэг загасаар бид зоог барьдаг. Гагцхүү байгалийн эдгээр цэвэр элементүүдээр л хүний сүнс ариусаж тэнхэрнэ.",
      },
      {
        num: "04",
        title: "Ойлгомжтой зам",
        body: "Тайга уудам. Бид алслагдмал аяллын саадыг бүрэн арилгана. Захиалга өгөхөөс эхлээд бидний хөрсөн дээр хөл тавих хүртэлх замыг саадгүй чиглүүлнэ.",
      },
      {
        num: "05",
        title: "Хөх сувдын хамгаалагчид",
        body: "Бид Хатгалд хариуцлага хүлээдэг. Цэвэр ашгийнхаа 10 хувийг нутгийн иргэдийн гарт шууд атгуулж, Хөвсгөлийн ирээдүйг батлан хамгаална.",
      },
      {
        num: "06",
        title: "Нээлттэй уулзвар",
        body: "Онгон байгаль бүх багийг хуулна. Уудам тэнгэрийн дор дэлхийн аялагчид болон нутгийн зон олон нээлттэй зүрх сэтгэлээр уулздаг үнэн, амьд харилцаа.",
      },
    ],
