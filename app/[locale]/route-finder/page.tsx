  ...
  const routes = [
    {
      ...
      content: (
        <div className="space-y-4">
          ...
          <p><strong>For the traveller who values depth over breadth.</strong> Most tourists lose 40% of their vacation staring at the back of a driver&apos;s seat. This route skips the long road entirely. You fly direct to Murun (MXV), giving you more days to explore the Taiga forest, visit the Reindeer tribes, and relax by the lake.</p>
  ...
  return (
    <main id="main-content" className="bg-white min-h-screen text-ink font-sans">
      ...
      <section className="max-w-3xl mx-auto px-6 py-12 text-center space-y-6 text-lg">
        ...
        <p>As locals, we see the same calculation error happen every summer. Travellers arrive with a checklist—ride a camel, see a monastery, gallop on the steppe—only to realise too late that they have left the story unfinished.</p>
        ...
        <p className="italic font-medium pt-4">Which path is right for you? In 60 seconds, this tool analyses your travel dates and style to match you with the perfect logistical plan—whether you want the &quot;Greatest Hits&quot; road trip or a direct luxury flight.</p>
      </section>
