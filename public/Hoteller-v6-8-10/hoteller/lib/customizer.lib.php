...
function hoteller_add_panels_and_sections( $wp_customize ) {
    ...
    $wp_customize->add_section( 'accommodation_currency', array(
        'title'       => __( 'Currency', 'hoteller' ),
        'panel'		  => 'accommodation',
        'priority'    => 58,
...
function hoteller_custom_setting( $controls ) {
    ...
    $tg_search_results_layout = array(
        'classic' => 'Classic',
        'list' => 'List View',
        'list-compact' => 'List View Compact',
        'grid' => 'Grid View',
    );
    ...
    $controls[] = array(
        ...
        'label'    => esc_html__('Label Settings', 'hoteller' ),
    ...
    $controls[] = array(
        ...
        'label'    => esc_html__('Label Typography', 'hoteller' ),
        'section'  => 'general_input',
        'default'  => 'Jost',
        'default'  => array(
            'font-family'    => 'Jost',
    ...
    $controls[] = array(
        ...
        'label'    => __( 'Label Font Color', 'hoteller' ),
        'section'  => 'general_input',
        'default'  => '#000000',
        'output' => array(
            array(
    ...
    $controls[] = array(
        ...
        'label'    => esc_html__('Thousand Separator', 'hoteller' ),
        'description' => esc_html__('Enter thousand separator of displayed price.', 'hoteller' ),
        'section'  => 'accommodation_currency',
        'default'  => ',',
        'priority' => 1,
    );
    ...
    $controls[] = array(
        ...
        'label'    => esc_html__('Decimal Separator', 'hoteller' ),
        'description' => esc_html__('Enter decimal separator of displayed price.', 'hoteller' ),
        'section'  => 'accommodation_currency',
        'default'  => '.',
        'priority' => 2,
    );
