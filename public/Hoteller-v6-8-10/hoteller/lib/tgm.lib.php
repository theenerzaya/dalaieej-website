...
function hoteller_require_plugins() {
    ...
    $plugins = array(
		...
		array(
			...
			'source'             => 'https://themegoods-assets.b-cdn.net/hoteller-elementor/hoteller-elementor-v4.1.2.zip',
			'required'           => true, 
			'version'            => '4.1.2',
		),
		array(
		...
		array(
			...
			'source'             => 'https://themegoods-assets.b-cdn.net/motopress-hotel-booking/motopress-hotel-booking-v5.4.1.zip',
			'required'  		 => true, 
			'version'            => '5.4.1',
		),
		array(
			...
			'source'             => 'https://themegoods-assets.b-cdn.net/mphb-request-payment/mphb-request-payment-v2.2.0.zip',
			'required'  		 => false, 
			'version'            => '2.2.0',
		),
		array(
			...
			'slug'      		 => 'mphb-invoices',
			'source'             => 'https://themegoods-assets.b-cdn.net/mphb-invoices/mphb-invoices-v1.5.2.zip',
			'required'  		 => false, 
			'version'            => '1.5.2',
		),
		array(
			...
			'source'             => 'https://themegoods-assets.b-cdn.net/mphb-woocommerce/mphb-woocommerce-v1.1.1.zip',
			'required'  		 => false, 
			'version'            => '1.1.1',
		),
		array(
			...
			'source'             => 'https://themegoods-assets.b-cdn.net/mphb-checkout-fields/mphb-checkout-fields-v1.2.3.zip',
			'required'  		 => false, 
			'version'            => '1.2.3',
		),
		array(
		...
		array(
			...
			'source'             => 'https://themegoods-assets.b-cdn.net/mphb-multi-currency/mphb-multi-currency-v1.2.8.zip',
			'required'  		 => false, 
			'version'            => '1.2.8',
		),
		array(
			...
			'slug'      		 => 'mphb-reviews',
			'source'             => 'https://themegoods-assets.b-cdn.net/mphb-reviews/mphb-reviews-v1.2.8.zip',
			'required'  		 => false, 
			'version'            => '1.2.8',
		),
		array(
